...
namespace Rhisis.World.Systems
{
    ...
    public sealed class RespawnSystem : ISystem
    {
        ...
        public void Execute(IEntity entity, SystemEventArgs args)
        {
            ...
            {
                if (monster.Object.Spawned && monster.TimerComponent.DespawnTime < Time.TimeInSeconds())
                {
                    Logger.LogDebug($"Despawning {monster.Object.Name}...");
                    monster.Object.Spawned = false;
                    monster.TimerComponent.RespawnTime = Time.TimeInSeconds() + monster.Region.Time;
                }
                else if (!monster.Object.Spawned && monster.TimerComponent.RespawnTime < Time.TimeInSeconds())
                {
